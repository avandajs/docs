...
#### Server Config
`server.ts`file is available for you to configure your [server](/api/configs/server). Add your client domain to the CORS Whitelist to prevent blocking of requests requests 
