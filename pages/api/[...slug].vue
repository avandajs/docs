<template>
    <page title="api" :blog="article" :show-table-content="articleLoaded">
      <article class="">
        <ClientOnly>
          <ContentRenderer class="prose lg:prose-base prose-sm prose-slate article-link pr-7 " :value="article">
            <template #empty>
